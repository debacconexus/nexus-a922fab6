...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Victim Services Coordination System";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Victim";
process.env.TABLE_NAME = process.env.TABLE_NAME || "victim_records";
'use strict';
